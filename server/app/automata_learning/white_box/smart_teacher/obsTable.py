import math
from app.automata_learning.white_box.smart_teacher.TimedWord import TimedWord, ResetTimedWord, LRTW_to_LTW, DRTW_to_LRTW
from app.automata_learning.white_box.smart_teacher.teacher import TQs
