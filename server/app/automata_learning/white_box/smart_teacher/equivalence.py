...
from app.automata_learning.white_box.smart_teacher.TimeInterval import Guard
from app.automata_learning.white_box.smart_teacher.TimedWord import TimedWord
...
def equivalence(model1, model2):
    upper_guard = max(model1.max_time_value(), model2.max_time_value())
