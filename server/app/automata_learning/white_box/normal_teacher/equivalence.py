...
import sys, os
from app.automata_learning.white_box.normal_teacher.ota import buildOTA, buildAssistantOTA, Timedword, ResetTimedword, State
...
from app.automata_learning.white_box.normal_teacher.otatable import Element, guess_ctx_reset
